...
const Skeleton = () => {
  ...
  return (
    <div className="flex flex-col justify-between gap-10 animate-pulse">
      <div>
        <div className={wrapperClass}>
          <div className={hoverTransformClass}>
            <svg
              aria-hidden="true"
              class="w-10 h-10 text-gray-200 animate-spin text-opacity-5 fill-rose-400"
              viewBox="0 0 100 101"
              fill="none"
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 xl:flex xl:flex-row gap-4 text-transparent">
            ...
            <p className={`${hoverClass} ${hoverTransformClass}`}>🍃 Clear</p>
            <p className={`${hoverClass} ${hoverTransformClass}`}>🌬️ 7</p>
          </div>
        </div>
      </div>
    </div>
